...
namespace WebAPI.Controllers {
	...
	public class AuctionController : AbstractController {
		...
		[SwaggerOperation(
			...
			- endTime (DateTime, required): Auction end time - 2025-07-08T14:30:00Z
			- images (IEnumerable<IFormFile>, required): >1 image")]
		[Authorize]
		[HttpPost("auctions")]
		...
		[SwaggerOperation(
			...
			- Only the seller can perform the update
			...
			- endTime (DateTime, optional): New end time for the auction - 2025-07-08T14:30:00Z
			- newImages (IEnumerable<FormFile>, optional): List of new images to add
			- removeImages (IEnumerable<string>, optional): List of existing images to remove")]
		[Authorize]
		...
		[SwaggerOperation(
			...
			Path parameters:
			- auctionId (GUID, required): ID of auction to retrieve")]
		[Authorize]
		...
		[SwaggerOperation(
			...
			- auctionId (GUID, required): ID of auction to pause")]
		[Authorize]
		...
		[SwaggerOperation(
			...
			Path parameters:
			- auctionId (GUID, required): ID of auction to resume

			Request body:
			- endTime (DateTime, required): New end time for the auction - 2025-07-08T14:30:00Z")]
		[Authorize]
		...
		[SwaggerOperation(
			...
			Path parameters:
			- auctionId (GUID, required): ID of auction to delete")]
		[Authorize]
